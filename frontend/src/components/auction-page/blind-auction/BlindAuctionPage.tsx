...
import BlindActionsCard from './BlindActionsCard'
import useNetwork from '../../../hooks/useNetwork'
import useClient from '../../../hooks/useClient'
import useBlindAuction from '../../../hooks/useBlindAuction'
import { BlindAuction, BlindAuctionStage } from '../../../common/blindAuction'
...
function BlindAuctionPage({ auctionAddress }: Props) {
    ...
    const [auction, setAuction] = useState(null as BlindAuction | null)
    ...
    const loadAuction = useCallback(async () => {
        ...
        try {
            ...
            const stage =
                !ended && !funded
                    ? BlindAuctionStage.WAITING_FOR_FUNDING
                    : now < biddingEnd
                      ? BlindAuctionStage.BIDDING
                      : now < revealEnd
                        ? BlindAuctionStage.REVEAL
                        : !ended
                          ? BlindAuctionStage.WAITING_FOR_END
                          : BlindAuctionStage.ENDED
